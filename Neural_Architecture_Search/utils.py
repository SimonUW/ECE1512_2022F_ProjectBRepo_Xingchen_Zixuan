...
def evaluate_synset(net, images_train, labels_train, testloader, args):
    net = net.to(args.device)
    ...
    lr_schedule = torch.optim.lr_scheduler.CosineAnnealingLR(optimizer, T_max=Epoch, eta_min=0)
